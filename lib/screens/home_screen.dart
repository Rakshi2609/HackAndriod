      ...
      child: Row(children: [
        Expanded(
            child: _toggleBtn(
                ...
                () => ref.read(doctorModeProvider.notifier).state = false,
                context)),
        Expanded(
            child: _toggleBtn(
                'Doctor View',
                ...
                () => ref.read(doctorModeProvider.notifier).state = true,
                context)),
      ]),
    );
  }

  Widget _toggleBtn(String label, bool active, IconData icon,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
            colors: [Color(0xFF1565C0), Color(0xFF2D9CDB)]),
        ...
        if (prescription == null)
          const Center(
            ...
            child: Column(children: [
              ...
              Text('Doctor will push one during consultation',
                  style:
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: AppColors.mintGreen.withOpacity(0.07),
                borderRadius: BorderRadius.circular(12),
                border:
            ...
            child:
              ...
              Row(children: [
                const Icon(Icons.verified_rounded,
                    color: AppColors.mintGreen, size: 16),
                const SizedBox(width: 6),
                const Text('Verified Digital Prescription',
                    style: TextStyle(
...
class _MainShellState extends State<MainShell> {
  ...
  @override
  Widget build(BuildContext context) =>
      widget.build(context, _currentIndex, setTab);
}
